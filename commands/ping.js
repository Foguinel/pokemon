...
if(message.author.id !== "449940691045318656" || !message.member.hasPermission(['MANAGE_GUILDS'])) return; // Primeiramente ele verifica se você tem as permissões de usar este comando.
